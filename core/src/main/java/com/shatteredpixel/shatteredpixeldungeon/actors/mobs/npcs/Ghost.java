...
import com.shatteredpixel.shatteredpixeldungeon.ui.dialog.quest.STAR15_Plot_L1;
import com.shatteredpixel.shatteredpixeldungeon.ui.dialog.quest.STAR15_Plot_L2;
import com.shatteredpixel.shatteredpixeldungeon.ui.dialog.quest.STAR15_Plot_L3;
		...
		if (Quest.given) {
						...
						public void call() {
							switch (Quest.type) {
								...
								default:
									...
									break;
								case 2:
									GameScene.show(new WndDialog(new STAR15_Plot_L2.End()));
									break;
								case 3:
									GameScene.show(new WndDialog(new STAR15_Plot_L3.End()));
									break;
							}
						}
					});
			...
			if (questBoss.pos != -1) {
				...
				Game.runOnRenderThread(new Callback() {
					@Override
					public void call() {
						GameScene.show(new WndDialog(txt_quest));
