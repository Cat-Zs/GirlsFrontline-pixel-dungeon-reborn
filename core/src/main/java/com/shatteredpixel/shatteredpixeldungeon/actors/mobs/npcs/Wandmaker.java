...
import com.shatteredpixel.shatteredpixeldungeon.ui.dialog.quest.M16A1_Plot_L1;
import com.shatteredpixel.shatteredpixeldungeon.ui.dialog.quest.M16A1_Plot_L2;
import com.shatteredpixel.shatteredpixeldungeon.ui.dialog.quest.M16A1_Plot_L3;
		...
		if (Quest.given) {
			...
			if (item != null) {
				...
				Game.runOnRenderThread(new Callback() {
					@Override
					public void call() {
						GameScene.show(new WndDialog(msg));
					}
				});
			}
			...
			Game.runOnRenderThread(new Callback() {
				@Override
				public void call() {
					GameScene.show(new WndDialog(dialog));
				}
			});
